...
class 乖乖吃飯_Admin(admin.ModelAdmin):
    list_display = ['num', 'name','price', 'grams', 'protein', 'fat', 'carbo', 'phos', 'kcal', 'score', 'times']
admin.site.register(乖乖吃飯,乖乖吃飯_Admin)

class 心靈雞湯_Admin(admin.ModelAdmin):
    list_display = ['num', 'name','price', 'grams', 'protein', 'fat', 'carbo', 'phos', 'score', 'times']
admin.site.register(心靈雞湯,心靈雞湯_Admin)

class pidan_Admin(admin.ModelAdmin):
    list_display = ['num', 'name','price', 'grams', 'material','ratio', 'score', 'times']
